...
if __name__ == "__main__":
    ...
    reload_img = ImageTk.PhotoImage(Image.open("D:/projects(python)/Captcha_Generator_In_Python_With_Source_Code/Captcha_Generator/refresh.png").resize((32, 32), Image.ANTIALIAS))
